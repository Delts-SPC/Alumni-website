...
const CHALLENGE_IMG =
  "https://customer-assets.emergentagent.com/job_affirmation-1/artifacts/h0rujc0q_AdobeStock_194166236%20medres%20square.jpg";
const EXPERTISE_IMG =
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12 lg:px-24 grid md:grid-cols-12 gap-12 items-center">
          ...
          <div className="md:col-span-7 md:pl-8 lg:pl-12">
            ...
            <p className="text-base md:text-lg text-slate-700 leading-relaxed mb-6">
              Most of us are navigating something. Often, we're figuring it out alone — no
              structure, no real support, no place to talk about it with people who actually
              understand.
            </p>

            <p className="text-base md:text-lg text-slate-700 leading-relaxed mb-6">
              What if that changed? We're building programs designed to help you move forward
              in what actually matters right now.
            </p>
